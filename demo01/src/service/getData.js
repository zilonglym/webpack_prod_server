...
const myFetchNoDo = (url = '', params = {},type = 'GET') => {
    var sessionId = localStorage.KKWEBAPP_sessionId;
    if(!sessionId){
        return 'notLogin';
    }
...
export const getMyNum = (params) => {
    return myFetchNoDo('webapp/user/j/getMyNum', params, 'POST');
};
...
export const wxGetUserInfo = (code,params) => {
    return myFetchNoLogin(`wxapp/api/j/getUserInfo/${code}`,params);
};
